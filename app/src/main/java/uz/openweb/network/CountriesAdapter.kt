...
class CountriesAdapter(private val countryHelper: CountryHelper) : RecyclerView.Adapter<VH>() {
    ...
    fun setCountries(list: ArrayList<Country>) {
...
class VH(private val binding: ItemCountryBinding, private val countryHelper: CountryHelper) : RecyclerView.ViewHolder(binding.root) {
    fun bind(item: Country) {
        binding.root.setOnClickListener { countryHelper.onItemClicked(item
        ) }
